...
We plan to read through the [third chapter](http://r4ds.had.co.nz/data-visualisation.html) of the book about data visualisation.
...
4. In section 3.3, ggplot advises against using the size of points in a scatterplot to represent a **discrete, cetegorial** variable (in this case, the class of vehicle).
...
How many colours can the human eye comfortably distinguish? At what point should one consider using faceting (i.e. segregating the points for each variable into a subplot) instead of putting everything in a single plot? See question 4 in section 3.5.1.
...
## Random code chunks I found interesting
